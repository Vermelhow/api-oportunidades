...
router.get('/pessoa/:pessoa_id', validateParamId('pessoa_id'), interessesController.listarPorPessoa.bind(interessesController));
router.get('/oportunidade/:oportunidade_id', validateParamId('oportunidade_id'), interessesController.listarPorOportunidade.bind(interessesController));
